      ...
      <div>
        <div className="video-container">
          <div className="featured-video">
            <video
              ...
              src={
                this.props.videos[1] &&
                this.props.videos[1].video_url + "#t=127,174.5"
              }
              muted={muted}
            ></video>
          </div>
        ...
        <div className="video-buttons-container">
          ...
          <div className="video-description">
            "To all the amazing, powerful, smart, creative, qualified, strong,
            beautiful, resilient, deserving women around the world who have ever
            been made to feel otherwise... this one's for you." -Sorah
          </div>
          <div className="video-buttons">
            <button
              className="play btn-secondary"
              onClick={this.goToPage(`/videos/${this.props.videos[1].id}`)}
            >
              PLAY
            </button>
            {!this.state.muted && (
              <button
                className="btn-secondary volume"
                onClick={this.toggleVolume}
              >
                <div className="unmuted"></div>
              </button>
            )}
            {this.state.muted && (
              <button
        ...
        <div className="video-links-container">
          <div className="tag-buttons">
            <Link to="/tags/1" className="tag-button">
              <img
                className="image"
                src="https://dancey-plus-seeds.s3-us-west-1.amazonaws.com/Disney+hip+hop.png"
                alt="Hip-Hop"
              />
              <video
                loop
            ...
            <Link to="/tags/2" className="tag-button">
              <img
                className="image"
                src="https://dancey-plus-seeds.s3-us-west-1.amazonaws.com/ballet.png"
                alt="Ballet"
              />
              <video
                loop
            ...
            <Link to="/tags/5" className="tag-button">
              <img
                className="image"
                src="https://dancey-plus-seeds.s3-us-west-1.amazonaws.com/latin_tag.png"
                alt="Latin"
              />
              <video
                loop
            ...
            <Link to="/tags/3" className="tag-button">
              <img
                className="image"
                src="https://dancey-plus-seeds.s3-us-west-1.amazonaws.com/jazzfunk.png"
                alt="Jazz-Funk"
              />
              <video
                loop
            ...
            <Link to="/tags/4" className="tag-button">
              <img
                className="image"
                src="https://dancey-plus-seeds.s3-us-west-1.amazonaws.com/lyrical_tag.png"
                alt="Lyrical"
              />
              <video
                loop
          ...
          <div className="tags-container">
            {this.props.tags.map((tag) => (
              <TagCarouselContainer key={tag.id} tag={tag} />
            ))}
          </div>
        </div>
      </div>
